...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/sobre-alport" },
};
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <div className="mt-6 flex items-center gap-3 rounded-xl border border-border bg-white p-5">
        <span className="font-heading text-3xl font-bold text-brand">{SITE.desde}</span>
        <p className="text-sm text-ink/80">
          <span className="block font-medium text-ink">
            {antiguedadAnios()} años de trayectoria en Puan
          </span>
          Abrimos nuestras puertas en {SITE.desde} y desde entonces seguimos siendo
          la primera opción de la zona para equipar el hogar.
        </p>
      </div>
